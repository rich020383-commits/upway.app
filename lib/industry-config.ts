...
export const INDUSTRY_CONFIG: Record<BusinessSegment, IndustryConfig> = {
  general: {
    ...
    metrics: [
      { key: 'totalLeads', label: 'Leads totales', hint: 'Base de datos completa', accent: 'text-sky-300' },
      { key: 'newLeads', label: 'Nuevos', hint: 'Sin primer contacto', accent: 'text-emerald-300' },
      { key: 'appointments', label: 'Citas próximas', hint: 'Agenda Upway', accent: 'text-violet-300' },
      { key: 'pendingReminders', label: 'Recordatorios', hint: 'Programados', accent: 'text-amber-300' },
      { key: 'todayAppointments', label: 'Hoy', hint: 'Citas del día', accent: 'text-rose-300' },
    ],
    pipeline: [
  ...
  inmobiliaria: {
    ...
    metrics: [
      { key: 'totalLeads', label: 'Interesados totales', hint: 'Base de prospectos', accent: 'text-sky-300' },
      { key: 'newLeads', label: 'Nuevos prospectos', hint: 'Sin primer contacto', accent: 'text-emerald-300' },
      { key: 'appointments', label: 'Visitas próximas', hint: 'Visitas a propiedades', accent: 'text-violet-300' },
      { key: 'pendingReminders', label: 'Seguimientos', hint: 'Programados', accent: 'text-amber-300' },
      { key: 'todayAppointments', label: 'Visitas hoy', hint: 'Agenda del día', accent: 'text-rose-300' },
    ],
    pipeline: [
  ...
  drogueria: {
    ...
    metrics: [
      { key: 'totalLeads', label: 'Clientes totales', hint: 'Base de compradores', accent: 'text-sky-300' },
      { key: 'newLeads', label: 'Nuevas solicitudes', hint: 'Sin primer contacto', accent: 'text-emerald-300' },
      { key: 'appointments', label: 'Pedidos en curso', hint: 'Entregas programadas', accent: 'text-violet-300' },
      { key: 'pendingReminders', label: 'Avisos', hint: 'Recordatorios de disponibilidad', accent: 'text-amber-300' },
      { key: 'todayAppointments', label: 'Entregas hoy', hint: 'Domicilios del día', accent: 'text-rose-300' },
    ],
    pipeline: [
  ...
  retail: {
    ...
    appointmentNoun: 'Cita',
    metrics: [
      { key: 'totalLeads', label: 'Clientes totales', hint: 'Base de clientes', accent: 'text-sky-300' },
      { key: 'newLeads', label: 'Nuevas consultas', hint: 'Sin primer contacto', accent: 'text-emerald-300' },
      { key: 'appointments', label: 'Citas próximas', hint: 'Asesorías y recogidas', accent: 'text-violet-300' },
      { key: 'pendingReminders', label: 'Recordatorios', hint: 'Programados', accent: 'text-amber-300' },
      { key: 'todayAppointments', label: 'Hoy', hint: 'Citas del día', accent: 'text-rose-300' },
    ],
    pipeline: [
  ...
  supermercado: {
    ...
    metrics: [
      { key: 'totalLeads', label: 'Clientes totales', hint: 'Base de compradores', accent: 'text-sky-300' },
      { key: 'newLeads', label: 'Nuevas solicitudes', hint: 'Sin primer contacto', accent: 'text-emerald-300' },
      { key: 'appointments', label: 'Pedidos próximos', hint: 'Entregas programadas', accent: 'text-violet-300' },
      { key: 'pendingReminders', label: 'Avisos', hint: 'Recordatorios programados', accent: 'text-amber-300' },
      { key: 'todayAppointments', label: 'Entregas hoy', hint: 'Domicilios del día', accent: 'text-rose-300' },
    ],
    pipeline: [
