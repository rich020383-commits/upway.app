 ...
 * marketing. El app (dashboard, panel health, store) queda fuera del índice:
 * son rutas con sesión y no aportan SEO.
 */
    ...
    rules: [
      {
        userAgent: '*',
        allow: '/',
        disallow: ['/api/', '/dashboard/', '/health/', '/store/', '/login', '/register'],
      },
    ],
