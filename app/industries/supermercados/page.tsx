...
const painPoints = [
  {
    ...
    text: 'Muchas preguntas de clientes se quedan sin respuesta o tardan demasiado en resolverse.',
    icon: MessageSquareText,
  },
  {
    title: 'Atención inconsistente',
    text: 'El equipo atiende cuando puede, pero la experiencia del cliente no siempre es clara ni ágil.',
    icon: Users,
  },
  {
    title: 'Promociones sin seguimiento',
    text: 'Oportunidades comerciales se pierden cuando la campaña no tiene continuidad ni conversión.',
    icon: TrendingUp,
  },
  {
    title: 'Operación manual',
    text: 'La coordinación interna y la respuesta a clientes se vuelve pesada a medida que crece el volumen.',
    icon: Clock3,
  },
];
...
const solutionPillars = [
  {
    ...
    text: 'Responde preguntas frecuentes, promociones y dudas de clientes sin esperar a que un humano lo haga.',
    icon: Sparkles,
  },
  {
    title: 'Promociones inteligentes',
    text: 'Ajusta ofertas, mensajes y sugerencias según el contexto del cliente y la intención de compra.',
    icon: ShoppingCart,
  },
  {
    title: 'Seguimiento útil',
    text: 'Mantén conversaciones activas con clientes interesados que aún no han decidido comprar.',
    icon: CheckCircle2,
  },
  {
    title: 'Operación escalable',
    text: 'Aumenta la capacidad de atención sin complicar la operación ni perder claridad en la experiencia.',
    icon: Store,
  },
];

const benefits = [
  'Más consultas convertidas en ventas',
  'Atención más rápida y consistente',
  'Menos trabajo manual repetitivo',
  'Experiencia mejor para clientes y equipo',
];
...
export default function SupermercadosLandingPage() {
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(90,129,255,0.16),_transparent_28%),linear-gradient(180deg,_#f8fbff_0%,_#edf4ff_100%)] text-slate-900">
      <header className="mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-6 md:px-10">
        <div className="flex items-center gap-3">
          <div className="flex h-11 w-11 items-center justify-center rounded-2xl border border-slate-200 bg-white/80 shadow-sm">
            <ShoppingCart className="h-5 w-5 text-[#2457f5]" />
          </div>
          <div>
            <div className="text-[10px] font-mono uppercase tracking-[0.22em] text-slate-500">Upway</div>
            <div className="text-lg font-black tracking-[-0.05em]">Supermercados</div>
          </div>
        </div>

        <div className="flex items-center gap-3">
          <Link href="/login?segment=supermercado" className="hidden rounded-full border border-slate-200 bg-white/80 px-4 py-2 text-sm font-semibold text-slate-700 shadow-sm transition hover:border-slate-300 md:inline-flex">
            Iniciar sesión
          </Link>
          <Link href="/login?segment=supermercado" className="inline-flex items-center gap-2 rounded-full bg-slate-900 px-4 py-2.5 text-sm font-semibold text-white shadow-[0_20px_50px_rgba(15,23,42,0.18)] transition hover:-translate-y-0.5">
      ...
      <main className="mx-auto max-w-7xl px-6 pb-20 md:px-10">
          ...
          <div className="grid items-center gap-10 lg:grid-cols-[1.08fr_0.92fr]">
            <div>
              ...
              <h1 className="mt-6 max-w-xl text-4xl font-black leading-[0.96] tracking-[-0.06em] text-slate-900 md:text-6xl">
                Servicio más rápido, ventas más claras y menos fricción operativa
              </h1>

              <p className="mt-5 max-w-xl text-base leading-7 text-slate-600 md:text-lg">
                Upway ayuda a supermercados y comercios con alta demanda a responder clientes, coordinar consultas y convertir más oportunidades sin saturar al equipo.
              </p>

              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <Link href="/login?segment=supermercado" className="inline-flex items-center justify-center gap-2 rounded-full bg-slate-900 px-6 py-3.5 text-sm font-semibold text-white shadow-[0_20px_50px_rgba(15,23,42,0.18)] transition hover:-translate-y-0.5">
                  Activar flujo supermercado
                  <ArrowRight className="h-4 w-4" />
                </Link>
                <button
                ...
                <div className="rounded-[26px] border border-white/10 bg-gradient-to-br from-[#0d1727] via-[#132d51] to-[#2457f5] p-5 text-white">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-mono uppercase tracking-[0.18em] text-blue-100/80">commerce flow</span>
                    </div>
                    <span className="rounded-full border border-white/15 bg-white/5 px-2 py-1 text-[10px] font-medium text-blue-100/80">supermercado</span>
                  </div>

                  <div className="mt-6 grid gap-4 md:grid-cols-2">
                    <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm">
                      <div className="text-[10px] font-mono uppercase tracking-[0.18em] text-blue-100/70">Consultas</div>
                      <div className="mt-3 text-3xl font-black tracking-[-0.06em]">+46%</div>
                      <div className="mt-2 text-sm text-blue-100/75">más respuestas efectivas</div>
                    </div>
                    <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm">
                      <div className="text-[10px] font-mono uppercase tracking-[0.18em] text-blue-100/70">Ventas</div>
                      <div className="mt-3 text-3xl font-black tracking-[-0.06em]">+33%</div>
                      <div className="mt-2 text-sm text-blue-100/75">más oportunidades cerradas</div>
                    </div>
                  </div>
                  ...
                  <div className="mt-5 rounded-2xl border border-white/10 bg-[#0b1422]/80 p-4">
                    ...
                    <div className="mt-4 space-y-3">
                      {['Consulta recibida', 'Oferta o respuesta guiada', 'Seguimiento activo', 'Venta o reserva convertida'].map((item, index) => (
        ...
        <section className="mt-20 rounded-[32px] border border-slate-200 bg-white/80 p-6 shadow-[0_24px_60px_rgba(15,23,42,0.06)] backdrop-blur-sm md:p-8">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-3 text-3xl font-black tracking-[-0.05em] text-slate-900 md:text-4xl">
              Cuando la atención no es clara, el cliente se va y la operación se vuelve más costosa.
            </h2>
          </div>
        ...
        <section className="mt-20">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-3 text-3xl font-black tracking-[-0.05em] text-slate-900 md:text-4xl">
              Una operación comercial más ágil sin perder calidad en la atención
            </h2>
          </div>
        ...
        <section className="mt-20 rounded-[32px] border border-slate-200 bg-slate-950 p-6 text-white shadow-[0_30px_80px_rgba(15,23,42,0.18)] md:p-8">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-3 text-3xl font-black tracking-[-0.05em] text-white md:text-4xl">
              Resultados reales para la operación comercial
            </h2>
          </div>
        ...
        <section className="mt-20">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-3 text-3xl font-black tracking-[-0.05em] text-slate-900 md:text-4xl">
              Diseñado para negocios con volumen y atención constante
            </h2>
          </div>
            ...
            <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
              <div className="max-w-2xl">
                ...
                <p className="mt-4 text-base leading-7 text-blue-100/80">
                  Diseñemos un sistema de atención, promoción y seguimiento que haga crecer tu operación comercial sin perder claridad ni servicio.
                </p>
              </div>

              <div className="flex flex-col gap-3 sm:flex-row">
                <Link href="/login?segment=supermercado" className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-6 py-3.5 text-sm font-semibold text-slate-900 transition hover:-translate-y-0.5">
                  Hablar con un especialista
                  <ArrowRight className="h-4 w-4" />
                </Link>
                <Link href="/login?segment=supermercado" className="inline-flex items-center justify-center gap-2 rounded-full border border-white/20 bg-white/5 px-6 py-3.5 text-sm font-semibold text-white transition hover:bg-white/10">
                  Iniciar sesión
                </Link>
              </div>
            </div>
      ...
      <footer className="mx-auto flex w-full max-w-7xl flex-col gap-4 border-t border-slate-200/80 px-6 py-8 text-sm text-slate-600 md:flex-row md:items-center md:justify-between md:px-10">
        <div className="flex items-center gap-3">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl border border-slate-200 bg-white/80 shadow-sm">
            <ShoppingCart className="h-4 w-4 text-[#2457f5]" />
          </div>
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <Link href="/login?segment=supermercado" className="transition hover:text-slate-900">Onboarding</Link>
