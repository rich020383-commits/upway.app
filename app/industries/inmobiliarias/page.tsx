  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(88,117,255,0.18),_transparent_27%),linear-gradient(180deg,_#f8fbff_0%,_#edf4ff_100%)] text-slate-900">
      <header className="mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-6 md:px-10">
        ...
        <div className="flex items-center gap-3">
          <Link href="/login?segment=inmobiliaria" className="hidden rounded-full border border-slate-200 bg-white/80 px-4 py-2 text-sm font-semibold text-slate-700 shadow-sm transition hover:border-slate-300 md:inline-flex">
            Iniciar sesión
          </Link>
          <Link href="/login?segment=inmobiliaria" className="inline-flex items-center gap-2 rounded-full bg-slate-900 px-4 py-2.5 text-sm font-semibold text-white shadow-[0_20px_50px_rgba(15,23,42,0.18)] transition hover:-translate-y-0.5">
          ...
          <div className="grid items-center gap-10 lg:grid-cols-[1.08fr_0.92fr]">
            <div>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <Link href="/login?segment=inmobiliaria" className="inline-flex items-center justify-center gap-2 rounded-full bg-slate-900 px-6 py-3.5 text-sm font-semibold text-white shadow-[0_20px_50px_rgba(15,23,42,0.18)] transition hover:-translate-y-0.5">
                  Activar flujo inmobiliario
                  <ArrowRight className="h-4 w-4" />
                </Link>
                <button
          ...
          <div className="rounded-[32px] border border-slate-200 bg-gradient-to-br from-[#0d1727] via-[#122841] to-[#1b5ed6] p-8 text-white shadow-[0_30px_80px_rgba(13,23,39,0.24)] md:p-10">
            <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                <Link href="/login?segment=inmobiliaria" className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-6 py-3.5 text-sm font-semibold text-slate-900 transition hover:-translate-y-0.5">
                  Hablar con un especialista
                  <ArrowRight className="h-4 w-4" />
                </Link>
                <Link href="/login?segment=inmobiliaria" className="inline-flex items-center justify-center gap-2 rounded-full border border-white/20 bg-white/5 px-6 py-3.5 text-sm font-semibold text-white transition hover:bg-white/10">
                  Iniciar sesión
                </Link>
              </div>
            </div>
      ...
      <footer className="mx-auto flex w-full max-w-7xl flex-col gap-4 border-t border-slate-200/80 px-6 py-8 text-sm text-slate-600 md:flex-row md:items-center md:justify-between md:px-10">
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <Link href="/login?segment=inmobiliaria" className="transition hover:text-slate-900">Onboarding</Link>
