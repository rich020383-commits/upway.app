...
const problems = [
  {
    title: 'Clientes indecisos',
    text: 'La mayoría de compradores necesita respuesta rápida para cerrar la decisión antes de perder interés.',
    icon: Users,
  },
  {
    title: 'Ventas perdidas',
    text: 'Muchas oportunidades se pierden porque no existe un seguimiento constante ni automatizado.',
    icon: TrendingUp,
  },
  {
    title: 'Atención inconsistente',
    text: 'El equipo responde cuando puede, pero no siempre con la velocidad ni la atención que exige el cliente.',
    icon: MessageSquareText,
  },
  {
    title: 'Operación manual',
    text: 'La coordinación interna y la atención basada en WhatsApp o llamadas se vuelve frágil y poco escalable.',
    icon: ShoppingBag,
  },
];
...
const solutionPillars = [
  {
    title: 'Captación más inteligente',
    text: 'Conecta con clientes en el momento correcto y responde de forma clara, útil y cercana.',
    icon: Sparkles,
  },
  {
    title: 'Seguimiento automatizado',
    text: 'Mantén conversaciones activas con clientes potenciales y reduce la pérdida de oportunidades.',
    icon: CheckCircle2,
  },
  {
    title: 'Experiencia de compra clara',
    text: 'Ayuda a los clientes a decidir, preguntar y avanzar hacia la compra sin esfuerzo.',
    icon: Store,
  },
  {
    title: 'Operación más escalable',
    text: 'Maximiza la productividad del equipo sin sacrificar servicio y atención personalizada.',
    icon: TrendingUp,
  },
];

const benefits = [
  'Más conversiones desde consultas y mensajes',
  'Menos oportunidades abandonadas',
  'Atención más rápida y más consistente',
  'Un equipo más productivo y una operación más clara',
];
...
export default function TiendasLandingPage() {
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(82,113,255,0.18),_transparent_27%),linear-gradient(180deg,_#f8fbff_0%,_#eef5ff_100%)] text-slate-900">
      <header className="mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-6 md:px-10">
        <div className="flex items-center gap-3">
          <div className="flex h-11 w-11 items-center justify-center rounded-2xl border border-slate-200 bg-white/80 shadow-sm">
            <Store className="h-5 w-5 text-[#2457f5]" />
          </div>
          <div>
            <div className="text-[10px] font-mono uppercase tracking-[0.22em] text-slate-500">Upway</div>
            <div className="text-lg font-black tracking-[-0.05em]">Retail & Tiendas</div>
          </div>
        </div>

        <div className="flex items-center gap-3">
          <Link href="/login?segment=retail" className="hidden rounded-full border border-slate-200 bg-white/80 px-4 py-2 text-sm font-semibold text-slate-700 shadow-sm transition hover:border-slate-300 md:inline-flex">
            Iniciar sesión
          </Link>
          <Link href="/login?segment=retail" className="inline-flex items-center gap-2 rounded-full bg-slate-900 px-4 py-2.5 text-sm font-semibold text-white shadow-[0_20px_50px_rgba(15,23,42,0.18)] transition hover:-translate-y-0.5">
            Activar flujo retail
      ...
      <main className="mx-auto max-w-7xl px-6 pb-20 md:px-10">
          ...
          <div className="grid items-center gap-10 lg:grid-cols-[1.08fr_0.92fr]">
            <div>
              ...
              <h1 className="mt-6 max-w-xl text-4xl font-black leading-[0.96] tracking-[-0.06em] text-slate-900 md:text-6xl">
                Convierte más consultas en ventas con atención más rápida
              </h1>

              <p className="mt-5 max-w-xl text-base leading-7 text-slate-600 md:text-lg">
                Upway ayuda a tiendas y negocios comerciales a responder clientes con rapidez, calificar consultas y coordinar ventas sin perder oportunidades.
              </p>

              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <Link href="/login?segment=retail" className="inline-flex items-center justify-center gap-2 rounded-full bg-slate-900 px-6 py-3.5 text-sm font-semibold text-white shadow-[0_20px_50px_rgba(15,23,42,0.18)] transition hover:-translate-y-0.5">
                  Activar flujo retail
                  <ArrowRight className="h-4 w-4" />
                </Link>
                ...
                <div className="rounded-[26px] border border-white/10 bg-gradient-to-br from-[#0d1727] via-[#132d51] to-[#2457f5] p-5 text-white">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-mono uppercase tracking-[0.18em] text-blue-100/80">sales flow</span>
                    </div>
                    <span className="rounded-full border border-white/15 bg-white/5 px-2 py-1 text-[10px] font-medium text-blue-100/80">retail</span>
                  </div>

                  <div className="mt-6 grid gap-4 md:grid-cols-2">
                    <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm">
                      <div className="text-[10px] font-mono uppercase tracking-[0.18em] text-blue-100/70">Consultas</div>
                      <div className="mt-3 text-3xl font-black tracking-[-0.06em]">+44%</div>
                      <div className="mt-2 text-sm text-blue-100/75">más respuestas en tiempo real</div>
                    </div>
                    <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm">
                      <div className="text-[10px] font-mono uppercase tracking-[0.18em] text-blue-100/70">Ventas</div>
                      <div className="mt-3 text-3xl font-black tracking-[-0.06em]">+29%</div>
                      <div className="mt-2 text-sm text-blue-100/75">más oportunidad convertida</div>
                    </div>
                  </div>
                  ...
                  <div className="mt-5 rounded-2xl border border-white/10 bg-[#0b1422]/80 p-4">
                    ...
                    <div className="mt-4 space-y-3">
                      {['Consulta recibida', 'Lead calificado', 'Respuesta automatizada', 'Seguimiento activo'].map((item, index) => (
        ...
        <section className="mt-20 rounded-[32px] border border-slate-200 bg-white/80 p-6 shadow-[0_24px_60px_rgba(15,23,42,0.06)] backdrop-blur-sm md:p-8">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-3 text-3xl font-black tracking-[-0.05em] text-slate-900 md:text-4xl">
              Los clientes esperan respuesta y muchas ventas se pierden por demora.
            </h2>
          </div>
        ...
        <section className="mt-20">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-3 text-3xl font-black tracking-[-0.05em] text-slate-900 md:text-4xl">
              Un sistema que da velocidad sin perder la atención humana
            </h2>
          </div>
        ...
        <section className="mt-20 rounded-[32px] border border-slate-200 bg-slate-950 p-6 text-white shadow-[0_30px_80px_rgba(15,23,42,0.18)] md:p-8">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-3 text-3xl font-black tracking-[-0.05em] text-white md:text-4xl">
              Impacto medible para la operación comercial
            </h2>
          </div>
            ...
            <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
              <div className="max-w-2xl">
                ...
                <p className="mt-4 text-base leading-7 text-blue-100/80">
                  Veamos cómo automatizar atención, calificar clientes y convertir más oportunidades sin perder la sensación de servicio premium.
                </p>
              </div>

              <div className="flex flex-col gap-3 sm:flex-row">
                <Link href="/login?segment=retail" className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-6 py-3.5 text-sm font-semibold text-slate-900 transition hover:-translate-y-0.5">
                  Hablar con un especialista
                  <ArrowRight className="h-4 w-4" />
                </Link>
                <Link href="/login?segment=retail" className="inline-flex items-center justify-center gap-2 rounded-full border border-white/20 bg-white/5 px-6 py-3.5 text-sm font-semibold text-white transition hover:bg-white/10">
                  Iniciar sesión
                </Link>
              </div>
            </div>
      ...
      <footer className="mx-auto flex w-full max-w-7xl flex-col gap-4 border-t border-slate-200/80 px-6 py-8 text-sm text-slate-600 md:flex-row md:items-center md:justify-between md:px-10">
        <div className="flex items-center gap-3">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl border border-slate-200 bg-white/80 shadow-sm">
            <Store className="h-4 w-4 text-[#2457f5]" />
          </div>
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <Link href="/login?segment=retail" className="transition hover:text-slate-900">Onboarding</Link>
